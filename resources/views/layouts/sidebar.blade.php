    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <x-nav-link href="home.html" icon="fa-home">Home</x-nav-link>
          
          <li class="nav-item dropdown">
            <x-nav-dropdown href="#navbar-network" icon="fa-box" text="Network">

              <ul class="dropdown-menu dropdown-menu-columns  dropdown-menu-columns-2">
                <x-nav-text href="#">Blank</x-nav-text>
                <x-nav-text href="#">Blank 2</x-nav-text>
              </ul>
          ...
          <x-nav-link href="home.html" icon="fa-heading">Form</x-nav-link>
